...
export class UsersettingsComponent implements OnInit {
  ...
  createForm(staff: IStaff) {
    ...
    this.updateStaffForm = this.fb.group({
      ...
      birthDate: [
        this.datepipe.transform(new Date(staff.birthDate), 'yyyy-MM-dd'),
        [Validators.required],
      ],
      email: [staff.email, [Validators.required]],
      file: [staff.file, [Validators.required]],
    ...
    if (this.updateStaffForm.valid) {
      this.crudservice
        ...
        .subscribe((data) => {
          ...
          this.alertify.message('Success Updated', {
  ...
  uploadImage(data: any) {
    ...
    this.updateStaffForm.patchValue({ file: image });
  }
}
