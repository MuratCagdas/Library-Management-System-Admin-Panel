...
import {
  CrudService,
  IListRequest,
} from '../../core/services/crud/crud.service';
...
export class FinepaymentComponent implements OnInit {
   ...
   *
   */
  constructor(private crudService: CrudService, private renderer: Renderer2) {}
  ngOnInit(): void {
    this.getListEBook();
  }
  ...
  getListEBook() {
    this.crudService
      .getList<IListRequest>({ controller: this.controller }, 0, 10)
      .subscribe((data: IListRequest) => {
