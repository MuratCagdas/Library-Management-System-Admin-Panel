...
export class UpdateLocationComponent implements OnInit {
      ...
      this.crudservice
        ...
        .pipe(
          catchError((err: HttpErrorResponse) => {
            return throwError(() => {
              this.alertify.message(err.error.message, {
  ...
  createForm(location: ILocation) {
    ...
    this.updateLocationForm = this.fb.group({
      ...
      floorNo: [location.floorNo, [Validators.required]],
      shelfName: [location.shelfName, [Validators.required]],
      shelfNo: [location.shelfNo, [Validators.required]],
    });
  }
}
